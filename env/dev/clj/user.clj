(ns user
  ...
  (:require
    ...
    [io.github.kit.playground.core :refer [start-app]]))
...
(defn dev-prep!
  ...
  (integrant.repl/set-prep! (fn []
                              (-> (io.github.kit.playground.config/system-config {:profile :dev})
                                  (ig/prep)))))

(defn test-prep!
  []
  (integrant.repl/set-prep! (fn []
                              (-> (io.github.kit.playground.config/system-config {:profile :test})
                                  (ig/prep)))))
